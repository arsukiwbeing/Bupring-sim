...
local Library = lib:Gui("Aras haxx")

local AutoFarmTab = Library:Tab("AutoFarm")
...
LocalPlayer:Button("WalkSpeed", function()
	while wait() do
		game.Players.LocalPlayer.Character:WaitForChild("Humanoid").WalkSpeed = 650
	end
end)
...
Misc:Button("Burp points", function()
...
Misc:Toggle("Wall noclip", function(bool)
